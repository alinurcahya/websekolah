...
<center>		 
            ...
            <tr id="rowHover">  
             <td width="30%" align="center"><?php echo $hasil['nama_siswa']; ?></td>  
                <td width="20%" align="center"><?php echo $hasil['nis']; ?></td>  
				<td width="19%" align="center"><?php echo $hasil['tempat_lahir']; ?></td> 
                <td width="15%" align="center"><?php echo $hasil['tanggal_lahir']; ?></td>  
				<td width="20%" align="center"><?php echo $hasil['jekel']; ?></td>  
				<td width="19%" align="center"><?php echo $hasil['status']; ?></td> 
