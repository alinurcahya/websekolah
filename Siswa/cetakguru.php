...
<center>		 
			...
			?>  
            <tr id="rowHover">  
             <td width="25%" align="center"><?php echo $hasil['nama_guru']; ?></td>  
                <td width="25%" align="center"><?php echo $hasil['NIP']; ?></td>  
				...
				<td width="25%" align="center"><?php echo $hasil['alamat']; ?></td> 
                <td width="25%" align="center"><?php echo $hasil['kota']; ?></td>  
				<td width="25%" align="center"><?php echo $hasil['kelas']; ?></td> 
				<td width="25%" align="center"><?php echo $hasil['kode_matpel']; ?></td> 
				<td width="25%" align="center"><?php echo $hasil['nama_matpel']; ?></td> 
				<td width="25%" align="center"><?php echo $hasil['nohp']; ?></td> 
				<td width="25%" align="center"><?php echo $hasil['email']; ?></td> 
				<td width="25%" align="center"><?php echo $hasil['Upload_Foto']; ?></td> 
            </tr>  
            <?php } ?>  
        </table>  
          <br>
