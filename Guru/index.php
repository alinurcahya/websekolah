...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			...
			<li><a href="profil.php">Galery SMP NEGERI 31 PADANG</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
...
<li><a href="view_siswa.php">Lihat Data Siswa</a></li>
		...
		<ul class="select"><li><a href="#"><b>Cetak Laporan</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
<li><a href="cetakguru.php">Cetak Data guru</a></li>
<li><a href="cetaksiswa.php">Cetak Siswa</a></li>
<li><a href="cetakjadwal.php">Cetak Jadwal</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
